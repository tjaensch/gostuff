...
<!--NCEI-MD added for extra service links -->
	...
	<xsl:variable name="summary" select="//*[@name='summary']/@value"/>
	<xsl:variable name="keywords" select="netcdf/keyword"/>
	<xsl:variable name="keywordsVocabulary" select="//*[@name='keywords_vocabulary']/@value"/>
...
<!-- Browse Graphic -->
	...
	<xsl:variable name="verticalMax" select="//*[@name='geospatial_vertical_max']/@value"/>
...
<!--Need to check with Pathfinder-->
	...
	<xsl:variable name="creatorName" select="//*[@name='creator_name']/@value"/>
	<xsl:variable name="creatorURL" select="//*[@name='creator_url']/@value"/>
	<xsl:variable name="creatorEmail" select="//*[@name='creator_email']/@value"/>
	<xsl:variable name="creatorDate" select="//*[@name='creation_date']/@value"/>
	<xsl:variable name="modifiedDate" select="//*[@name='date_modified']/@value"/>
	<xsl:variable name="issuedDate" select="//*[@name='date_issued']/@value"/>
	...
	<xsl:variable name="project" select="//*[@name='project']/@value"/>
	<xsl:variable name="acknowledgment" select="//*[@name='acknowledgment']/@value"/>
	...
	<xsl:variable name="creatorTotal" select="'1'"/>
	   ...
	   <!-- Data contributor  -->
	<xsl:variable name="contributorName"  select="//*[@name='contributor_name']/@value"/>
	<xsl:variable name="contributorRole"  select="//*[@name='contributor_role']/@value"/>
	...
	<xsl:variable name="cdmType" select="//*[@name='cdm_data_type']/@value"/>
	<xsl:variable name="license" select="//*[@name='license']/@value"/>
	...
	<xsl:template match="/">
		<gmi:MI_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gmx="http://www.isotc211.org/2005/gmx" xsi:schemaLocation="http://www.isotc211.org/2005/gmi http://www.ngdc.noaa.gov/metadata/published/xsd/schema.xsd">
			...
			<gmd:parentIdentifier>
				<gmx:Anchor xlink:href="http://dx.doi.org/10.7289/V5QJ7F8R" xlink:actuate="onRequest" xlink:title="DOI">doi:10.7289/V5QJ7F8R</gmx:Anchor>
			</gmd:parentIdentifier>
			<gmd:hierarchyLevel>
						...
						<gmd:CI_Citation>
							...
							<xsl:if test="$contributorTotal">
								<xsl:call-template name="writeResponsibleParty">
									...
									<xsl:with-param name="roleCode" select="//*[@name='contributor_role']/@value"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="$comment">
				...
				<gmd:abstract>
					<xsl:choose>
						<xsl:when test="count(netcdf/attribute[@name='summary']) > 0">
							<xsl:call-template name="writeCharacterString">
								<xsl:with-param name="stringToWrite" select="//*[@name='summary']/@value"/>
							</xsl:call-template>
						</xsl:when>
						<xsl:otherwise>
							<xsl:call-template name="writeCharacterString">
